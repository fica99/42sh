...
/*   Updated: 2019/12/07 17:42:42 by ggrimes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "calc.h"

static int	calc_check_var_inc(t_calc_tkns *s_tokens, size_t index)
{
	t_calc_tkntype	type;
...
static int	calc_var_next(int result, t_calc_tkns *s_tokens,
...
int			calc_var(t_calc_tkns *s_tokens, size_t *index, t_calc_err *error)
{
	int		result;
