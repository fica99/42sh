...
/*   Updated: 2019/12/07 17:53:25 by ggrimes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				calc_number(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
int				calc_unary(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
...
int				calc_mul_div_mod(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
...
int				calc_eq_diff(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
...
int				calc_log(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
...
int				calc(char *str, t_calc_err *error);
int				calc_exp(t_calc_tkns *s_tokens, size_t index,
	t_calc_err *error);
...
int				calc_var(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
int				calc_var_inc(t_calc_tkns *s_tokens, size_t *index,
	t_calc_err *error);
