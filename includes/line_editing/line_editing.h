...
/*   Updated: 2019/09/19 21:41:59 by aashara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	heredoc.c
*/
char				*check_heredoc(t_buff buffer, t_buff *stop_buff,
t_cord *cord);
short				find_heredoc(char *buffer);
void				print_heredoc(char *buffer, t_cord *cord);
void				check_heredoc_end(char *buffer, char *stop_buff,
t_cord *cord);
...
**	cut_copy_paste.c
*/
void				copy_highlight(t_buff *copy_buff, t_buff *buffer,
t_cord *cord);
void				paste_highlight(t_buff *buffer, t_buff *copy_buff,
t_cord *cord);
...
char				*quotes_dquotes_brackets(short q, short dq, short br,
t_line *line);
